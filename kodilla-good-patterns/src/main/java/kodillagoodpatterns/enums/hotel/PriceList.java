package kodillagoodpatterns.enums.hotel;
...
public class PriceList {
    ...
    private static Map<Season, BigDecimal> singelBedPrices = Map.of(
    ...
    public static BigDecimal getSingelBedPrice(Season season) {
        return singelBedPrices.get(season);
    }
